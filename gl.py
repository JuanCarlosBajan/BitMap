...
from mathJCB import cross, getMatrixInverse, normalized, subtract, matrix_multiplication, vector_matrix_multiplication
...
class Renderer(object):
    ...
    def glDirTransform(self, dirVector, rotMatrix):
        ...
        vt = vector_matrix_multiplication(rotMatrix, v)
        vf = V3(vt[0],
                vt[1],
                vt[2])
    ...
    def glCamTransform(self, vertex):
        v = V4(vertex[0], vertex[1], vertex[2], 1)
        vt = vector_matrix_multiplication(self.viewMatrix, v)
        vt = vector_matrix_multiplication(self.projectionMatrix, vt )
        vt = vector_matrix_multiplication(self.viewportMatrix, vt)
        vf = V3(vt[0] / vt[3],
                vt[1] / vt[3],
                vt[2] / vt[3])
